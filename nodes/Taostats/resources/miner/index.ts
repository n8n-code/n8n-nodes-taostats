...
export const minerDescription: INodeProperties[] = [
		{
		...
		{
			"displayName": "GET /api/miner/autostake/v1",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Destination Hotkey",
